...
<body>
    ...
    <form action="test.php?id_pengaduan=<?php echo $id_pengaduan?>" method="POST" enctype="multipart/form-data">
    <h1 style="margin-top: 30px; text-align: center; color: white;">Tanggapan</h1>
    <div class="container">
      <div class="mb-3">
        <label for="isi_laporan" class="form-label" style="color: white;">Tanggapan</label>
